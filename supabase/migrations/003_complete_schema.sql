...
VALUES 
  ('6e2bdefa-c205-4967-9021-2c666de3718f', '1001234567', 'Primary Checking', 'checking', 15250.75, 'USD'),
  ('6e2bdefa-c205-4967-9021-2c666de3718f', '2001234567', 'Savings Account', 'savings', 45000.00, 'USD')
ON CONFLICT (account_number) DO UPDATE SET
  account_name = EXCLUDED.account_name,
  balance = EXCLUDED.balance;

-- Insert test transactions
INSERT INTO transactions (from_account_id, to_account_id, amount, currency, description, recipient_name, status, created_at)
SELECT 
  a1.id,
  a2.id,
  500.00,
...
INSERT INTO transactions (from_account_id, amount, currency, description, recipient_name, status, created_at)
SELECT 
  a1.id,
  1200.00,
  'USD',
