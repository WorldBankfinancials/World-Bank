-- World Bank Supabase Public Schema Setup
-- This creates the complete banking system in Supabase public schema with realtime
...
INSERT INTO bank_accounts (user_id, account_number, account_type, balance, currency) VALUES 
(1, '4789-5532-1098-7654', 'checking', 15750.50, 'USD'),
(1, '4789-5532-1098-7655', 'savings', 25000.75, 'USD'),
(1, '4789-5532-1098-7656', 'investment', 45000.00, 'USD')
...
CREATE POLICY "Users can view own data" ON bank_users
...
CREATE POLICY "Service role can manage all data" ON bank_users
  FOR ALL USING (auth.role() = 'service_role');

CREATE POLICY "Service role can manage all accounts" ON bank_accounts
  FOR ALL USING (auth.role() = 'service_role');
