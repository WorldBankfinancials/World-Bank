...
const translations = {
  en: {
    ...
    'send_money_description': 'Send money worldwide securely',
    'you_send': 'You Send',
    'recipient_gets': 'Recipient Gets',
    'bank_grade_security': 'Bank-Grade Security',
    'real_time_transfer': 'Real-time Transfer',
    'best_rates_guaranteed': 'Best Rates Guaranteed',
    'quick_transfer_calculator': 'Quick Transfer Calculator',
    '190_countries': '190+ Countries',
    'recipient_information': 'Recipient Information',
    'recent_recipients': 'Recent Recipients',
    'add_new_recipient': 'Add New Recipient',
    'why_choose_world_bank': 'Why Choose World Bank?',
    'best_exchange_rates': 'Best Exchange Rates',
    'guaranteed_competitive_rates': 'Guaranteed competitive rates',
    '256bit_encryption': '256-bit encryption & fraud protection',
    'ultra_fast_delivery': 'Ultra-Fast Delivery',
    'real_time_same_day': 'Real-time to same-day delivery',
    'support_24_7': '24/7 Support',
    'multilingual_service': 'Multilingual customer service',
    ...
    'select_chat_session': 'Select a chat session',
    'chat_with': 'Chat with',
    ...
    'government_issued_id_verification': 'Government Issued ID',
    ...
    'proof_of_residence_verification': 'Proof of Residence',
    'income_verification': 'Income Verification',
    'employment_and_income_proof': 'Employment & Income Proof',
    'enhanced_due_diligence': 'Enhanced Due Diligence',
    'additional_verification_high_value': 'Additional Verification',
    'biometric_verification': 'Biometric Verification',
    'facial_recognition_fingerprint': 'Facial Recognition & Fingerprint',
    'under_review': 'Under Review',
    'tax_compliance': 'Tax Compliance',
    'tax_residency_status': 'Tax Residency Status',
    'upload_documents': 'Upload Documents',
    'regulatory_compliance': 'Regulatory Compliance',
    'verification_compliance_description': 'We comply with international banking regulations and standards',
  ...
  zh: {
    ...
    'fully_verified': '完全验证',
    'total_verifications': '总验证数',
    'all_verifications': '所有验证',
    'identity_verification': '身份验证',
    'government_issued_id_verification': '政府签发身份证',
    ...
    'proof_of_residence_verification': '居住证明',
    'income_verification': '收入验证',
    'employment_and_income_proof': '就业和收入证明',
    'enhanced_due_diligence': '加强尽职调查',
    'additional_verification_high_value': '附加验证',
    'biometric_verification': '生物识别验证',
    'facial_recognition_fingerprint': '面部识别和指纹',
    'under_review': '审核中',
    'tax_compliance': '税务合规',
    'tax_residency_status': '税务居住地状态',
    'upload_documents': '上传文件',
    'regulatory_compliance': '监管合规',
    'verification_compliance_description': '我们遵守国际银行法规和标准',
    'know_your_customer_kyc': '了解你的客户 (KYC)',
