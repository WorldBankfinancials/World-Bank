        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm wb-text">
              <li><Link href="/dashboard" className="hover:text-blue-600">{t('personal_banking')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm wb-text">
              ...
              <li><Link href="/security-center" className="hover:text-blue-600">{t('privacy_policy')}</Link></li>
            </ul>
          </div>
