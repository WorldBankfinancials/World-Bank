      ...
      <div className="pt-16 pb-20">
        ...
        <div className="px-4 py-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {t("investment_portfolio") || "Investment Portfolio"}
              </h1>
              <p className="text-gray-600">
                {t("manage_investments") || "Manage your investment portfolio"}
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm font-medium ${marketRates.stocks.trending === "up" ? "text-green-600" : "text-red-600"}`}
                    >
                      {marketRates.stocks.change > 0 ? "+" : ""}
                      {marketRates.stocks.change}%
                    </span>
                  </div>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm font-medium ${marketRates.bonds.trending === "up" ? "text-green-600" : "text-red-600"}`}
                    >
                      {marketRates.bonds.change > 0 ? "+" : ""}
                      {marketRates.bonds.change}%
                    </span>
                  </div>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm font-medium ${marketRates.crypto.trending === "up" ? "text-green-600" : "text-red-600"}`}
                    >
                      {marketRates.crypto.change > 0 ? "+" : ""}
                      {marketRates.crypto.change}%
                    </span>
                  </div>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm font-medium ${marketRates.forex.trending === "up" ? "text-green-600" : "text-red-600"}`}
                    >
                      {marketRates.forex.change > 0 ? "+" : ""}
                      {marketRates.forex.change}%
                    </span>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>
                {t("investment_actions") || "Investment Actions"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-sm">
                    {t("portfolio_review") || "Portfolio Review"}
                  </span>
                </Button>
                <Button
                  variant="outline"
                ...
                >
                  ...
                  <span className="text-sm">
                    {t("market_analysis") || "Market Analysis"}
                  </span>
                </Button>
                <Button
                  variant="outline"
