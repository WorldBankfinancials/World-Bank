...
export default function MultiStepRegisterPage() {
    ...
    const handleStep4Submit = async (data, idCardFile) => {
    ...
    const renderCurrentStep = () => {
        switch (currentStep) {
            case 1:
                return (_jsx(RegistrationStep1, { initialData: {
            ...
            case 2:
                return (_jsx(RegistrationStep2, { initialData: {
                    ...
                    }, onNext: handleStep2Next, onBack: handleBack }));
            case 3:
                return (_jsx(RegistrationStep3, { initialData: {
                    ...
                    }, onNext: handleStep3Next, onBack: handleBack }));
            case 4:
                return (_jsx(RegistrationStep4, { initialData: {
                    ...
                    }, onSubmit: handleStep4Submit, onBack: handleBack, isLoading: isSubmitting }));
            default:
                return null;
        }
    };
    return (_jsx("div", { className: "registration-container", children: renderCurrentStep() }));
}
